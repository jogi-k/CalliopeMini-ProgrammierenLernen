...
\setbeamertemplate{footline}{{\vspace{2mm}\color{mygray}\includegraphics[width=20pt]{./calliope.png}\hspace*{2mm}\tiny\insertsubtitle\hspace*{2mm}\inserttitle\hspace*{80pt}\hfill\includegraphics[width=20pt]{turbine.png}\insertframenumber/\inserttotalframenumber\ \hspace*{2mm}\vspace{2mm}}}
